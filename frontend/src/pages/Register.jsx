...
import { User, Mail, Lock, UserCircle, ArrowRight, Calendar, Eye, EyeOff } from "lucide-react";
...
export default function Register() {
  ...
  return (
    <div className="h-screen w-full flex flex-col lg:flex-row overflow-hidden">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center p-8 lg:p-24 bg-white order-2 lg:order-1 overflow-hidden">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    placeholder="Suraj"
                    className={`w-full pl-10 pr-4 py-3 bg-gray-50 border ${errors.firstName ? 'border-red-500' : 'border-gray-200'} rounded-xl focus:ring-2 focus:ring-black focus:border-transparent outline-none transition-all`}
                    {...register("firstName", {
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    placeholder="Verma"
                    className={`w-full pl-10 pr-4 py-3 bg-gray-50 border ${errors.lastName ? 'border-red-500' : 'border-gray-200'} rounded-xl focus:ring-2 focus:ring-black focus:border-transparent outline-none transition-all`}
                    {...register("lastName", {
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 bg-gray-50 border ${errors.username ? 'border-red-500' : 'border-gray-200'} rounded-xl focus:ring-2 focus:ring-black focus:border-transparent outline-none transition-all`}
      ...
      <div className="w-full lg:w-1/2 bg-[#050505] relative overflow-hidden flex items-center justify-center p-8 order-1 lg:order-2 min-h-[300px] lg:min-h-screen">
        ...
        <div className="relative z-10 w-full max-w-lg text-center lg:text-left">
            ...
            <div className="text-center">
                <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">Join Eventify</h2>
                <p className="text-gray-400 text-lg leading-relaxed max-w-md mx-auto">
                    Create an account to start managing your events and reminders efficiently.
                </p>
            </div>
        </div>
      </div>
